...
<script runat="server">
    ...
    Protected Sub Page_LoadComplete() Handles Me.LoadComplete
        ...
        tr_o23FreeText03.Visible = False : tr_o23FreeText06.Visible = False : tr_o23FreeText05.Visible = False
    ...
    Private Sub RefreshRecord()
        ...
        x20IDs.Add(5) : x20IDs.Add(6) : x20IDs.Add(8) : x20IDs.Add(9)
        ...
        If lisX19.Exists(Function(p) p.x20ID = 5) Then
            Me.p41ID.Value = lisX19.First(Function(p) p.x20ID = 5).x19RecordPID.ToString
            Me.p41ID.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p41Project, Me.p41ID.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 6) Then
            Me.p28ID_Objednatel.Value = lisX19.First(Function(p) p.x20ID = 6).x19RecordPID.ToString
            Me.p28ID_Objednatel.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p28Contact, Me.p28ID_Objednatel.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 8) Then
            Me.p28ID_Prevzal.Value = lisX19.First(Function(p) p.x20ID = 8).x19RecordPID.ToString
            Me.p28ID_Prevzal.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p28Contact, Me.p28ID_Prevzal.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 9) Then
            Me.j02ID_Vypracoval.Value = lisX19.First(Function(p) p.x20ID = 9).x19RecordPID.ToString
        ...
        With cRec
            ...
            Me.o23FreeText01.Text = .o23FreeText01
            If Not .o23FreeDate01 Is Nothing Then
                Me.o23FreeDate01.SelectedDate = .o23FreeDate01
            End If
            If Not .o23FreeDate02 Is Nothing Then
                Me.o23FreeDate02.SelectedDate = .o23FreeDate02
            End If
            If Not .o23FreeDate04 Is Nothing Then
                Me.o23FreeDate04.SelectedDate = .o23FreeDate04
            End If
            If Not .o23FreeDate05 Is Nothing Then
                Me.o23FreeDate05.SelectedDate = .o23FreeDate05
            End If
            ...
            Me.o23FreeText09.Text = .o23FreeText09
            ...
            Me.o23FreeNumber01.Value = .o23FreeNumber01
            Me.o23FreeNumber02.Value = .o23FreeNumber02
            Me.o23FreeNumber03.Value = .o23FreeNumber03
            Me.o23FreeNumber04.Value = .o23FreeNumber04
            Me.o23FreeNumber05.Value = .o23FreeNumber05
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If intP41ID = 0 Or intP28ID_Objednatel = 0 Or intJ02ID_Vypracoval = 0 Or Trim(Me.o23Name.Text) = "" Or Trim(Me.o23FreeText01.Text) = "" Then
            Master.Notify("[Projekt], [Objednatel] a [Vypracoval], [Název] a [Pořadové číslo] jsou povinná pole.", UI.NotifyLevel.ErrorMessage) : Return
        End If
        With cRec
            If Master.DataPID = 0 Then
            ...
            .o23FreeText01 = Me.o23FreeText01.Text
            ...
            .o23FreeText09 = Me.o23FreeText09.Text
            ...
            Else
                .o23FreeText13 = ""
            End If
            If Not Me.o23FreeDate01.IsEmpty Then
                .o23FreeDate01 = Me.o23FreeDate01.SelectedDate
            Else
                .o23FreeDate01 = Nothing
            End If
            If Not Me.o23FreeDate02.IsEmpty Then
                .o23FreeDate02 = Me.o23FreeDate02.SelectedDate
            Else
                .o23FreeDate02 = Nothing
            End If
            If Not Me.o23FreeDate04.IsEmpty Then
                .o23FreeDate04 = Me.o23FreeDate04.SelectedDate
            Else
                .o23FreeDate04 = Nothing
            End If
            If Not Me.o23FreeDate05.IsEmpty Then
                .o23FreeDate05 = Me.o23FreeDate05.SelectedDate
            Else
                .o23FreeDate05 = Nothing
            End If
            .o23FreeNumber01 = BO.BAS.IsNullNum(Me.o23FreeNumber01.Value)
            .o23FreeNumber02 = BO.BAS.IsNullNum(Me.o23FreeNumber02.Value)
            .o23FreeNumber03 = BO.BAS.IsNullNum(Me.o23FreeNumber03.Value)
            .o23FreeNumber04 = BO.BAS.IsNullNum(Me.o23FreeNumber04.Value)
            .o23FreeNumber05 = BO.BAS.IsNullNum(Me.o23FreeNumber05.Value)
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellpadding="10">
        <tr>
            ...
            <td>
                <span class="valboldblue">Znalecký posudek</span>
            </td>
        </tr>
    </table>
    <div class="div6">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <uc:contact ID="p28ID_Prevzal" runat="server" Width="250px" Flag="" />
    ...
    <table cellpadding="6">
        <tr>
            ...
            <td>
                <asp:TextBox ID="o23Name" runat="server" Width="600px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <span class="lblReq">Pořadové číslo:</span>
            </td>
            <td>
                <asp:TextBox ID="o23FreeText01" runat="server" Width="100px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <span>Datum doručení žádosti o provedení úkonu:</span>
            </td>
            <td>
        ...
        <tr>
            <td>
                <span>Lhůta pro provedení úkonu:</span>
            </td>
            <td>
        ...
        <tr>
            <td>
                <span>Datum provedení úkonu:</span>
            </td>
            <td>
                <telerik:RadDatePicker ID="o23FreeDate04" runat="server" Width="120px" SharedCalendarID="SharedCalendar">
        ...
        <tr>
            <td>Počet hodin účtovaných orgánům veřejné moci:</td>
            <td>
                <telerik:RadNumericTextBox ID="o23FreeNumber01" runat="server" NumberFormat-DecimalDigits="2" Width="100px" ShowSpinButtons="false"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>Výše účtované odměny (bez DPH):</td>
            <td>
                <telerik:RadNumericTextBox ID="o23FreeNumber02" runat="server" NumberFormat-DecimalDigits="2" Width="100px" ShowSpinButtons="false"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>Výše účtované náhrady nákladů:</td>
            <td>
                <telerik:RadNumericTextBox ID="o23FreeNumber03" runat="server" NumberFormat-DecimalDigits="2" Width="100px" ShowSpinButtons="false"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>Výše přiznané odměny (bez DPH):</td>
            <td>
                <telerik:RadNumericTextBox ID="o23FreeNumber04" runat="server" NumberFormat-DecimalDigits="2" Width="100px" ShowSpinButtons="false"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>Výše přiznané náhrady nákladů:</td>
            <td>
                <telerik:RadNumericTextBox ID="o23FreeNumber05" runat="server" NumberFormat-DecimalDigits="2" Width="100px" ShowSpinButtons="false"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>
                <span>Den proplacení odměny a náhrady nákladů:</span>
            </td>
            <td>
                <telerik:RadDatePicker ID="o23FreeDate05" runat="server" Width="120px" SharedCalendarID="SharedCalendar">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="o23FreeText09" runat="server" Width="100px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
