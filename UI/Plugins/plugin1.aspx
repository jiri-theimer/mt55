...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellpadding="10">
        <tr>
            ...
            <td>
                <button type="button" onclick="personalpage()">Nastavit si jinou osobní (výchozí) stránku</button>
            </td>
        </tr>
    </table>
    ...
    <uc:plugin_datatable ID="tabHours1" TableID="gridHours1" runat="server"
        ColHeaders="Pozice|Osoba|Dnes|Včera|Tento týden|Tento měsíc|Z toho fakturovatelné"
        ColHideRepeatedValues="1" ColTypes="S|S|N|N|N|N|N" ColFlexSubtotals="1|0|11|11|11|11|11"
...
WHERE a.p31date BETWEEN @d1_mesic and @d2_mesic
GROUP BY a.j02ID
