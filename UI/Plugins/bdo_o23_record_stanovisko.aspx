...
<script runat="server">
    ...
    Private Sub RefreshRecord()
        ...
        x20IDs.Add(15) : x20IDs.Add(16) : x20IDs.Add(17) : x20IDs.Add(18)
        ...
        If lisX19.Exists(Function(p) p.x20ID = 15) Then
            Me.p41ID.Value = lisX19.First(Function(p) p.x20ID = 15).x19RecordPID.ToString
            Me.p41ID.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p41Project, Me.p41ID.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 16) Then
            Me.p28ID_Objednatel.Value = lisX19.First(Function(p) p.x20ID = 16).x19RecordPID.ToString
            Me.p28ID_Objednatel.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p28Contact, Me.p28ID_Objednatel.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 17) Then
            Me.p28ID_Prevzal.Value = lisX19.First(Function(p) p.x20ID = 17).x19RecordPID.ToString
            Me.p28ID_Prevzal.Text = Master.Factory.GetRecordCaption(BO.x29IdEnum.p28Contact, Me.p28ID_Prevzal.Value, True)
        End If
        If lisX19.Exists(Function(p) p.x20ID = 18) Then
            Me.j02ID_Vypracoval.Value = lisX19.First(Function(p) p.x20ID = 18).x19RecordPID.ToString
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table cellpadding="10">
        <tr>
            ...
            <td>
                <span class="valboldblue">Stanovisko</span>
            </td>
        </tr>
    </table>
    <div class="div6">
