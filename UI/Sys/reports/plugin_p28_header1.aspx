            ...
            With cRec
                If .p51ID_Billing > 0 Then
                    ...
                    If .p51Name_Billing.IndexOf(cRec.p28Name) >= 0 Then
                        'sazby na míru
                        p51Name_Billing.Text = "Fakturační sazby na míru"
                    End If
                End If
               
            End With
            Me.ClientRoles.Text = Master.Factory.p28ContactBL.GetRolesInline(Master.DataPID)
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="float:left;padding:6px;">
        Role v klientovi:
        <asp:Label ID="ClientRoles" runat="server" CssClass="valbold"></asp:Label>
    </div>
