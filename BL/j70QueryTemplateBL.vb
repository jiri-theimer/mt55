...
Class j70QueryTemplateBL
        ...
        Select Case x29id
            ...
            Case BO.x29IdEnum.p31Worksheet
                ...
                For Each c In lisX18
                    ...
                    lis.Add(AGC(Left(c.x18Name, 20), "tag" & x.ToString & "_" & c.PID.ToString, BO.cfENUM.AnyString, , strSql, , , "Kategorie projektu", "min(" & strSql & ")", strSql))
                Next
                lisX18 = Factory.x18EntityCategoryBL.GetList(, BO.x29IdEnum.p28Contact, -1).Where(Function(p) p.x18IsManyItems = False)
                For Each c In lisX18
                    x += 1
                    Dim strSql As String = "dbo.stitek_hodnoty(" & c.PID.ToString & ",328,p41.p28ID_Client)"
                    lis.Add(AGC(Left(c.x18Name, 20), "tag" & x.ToString & "_" & c.PID.ToString, BO.cfENUM.AnyString, , strSql, , , "Kategorie klienta projektu", "min(" & strSql & ")", strSql))
                Next
                lisX18 = Factory.x18EntityCategoryBL.GetList(, BO.x29IdEnum.p56Task, -1).Where(Function(p) p.x18IsManyItems = False)
                For Each c In lisX18
                    x += 1
                    Dim strSql As String = "dbo.stitek_hodnoty(" & c.PID.ToString & ",356,a.p56ID)"
                    lis.Add(AGC(Left(c.x18Name, 20), "tag" & x.ToString & "_" & c.PID.ToString, BO.cfENUM.AnyString, , strSql, , , "Kategorie úkolu", "min(" & strSql & ")", strSql))
                Next
        End Select
    End Sub
    ...
    Private Sub InhaleP41ColList(ByRef lis As List(Of BO.GridColumn))
        With lis
            ...
            If Factory.TestPermission(BO.x53PermValEnum.GR_P31_AllowRates) Then
                Dim strFR As String = "LEFT OUTER JOIN tview_p41_worksheet(@dp31f1,@dp31f2) alfa ON a.p41ID=alfa.p41ID", strHR As String = "Vykázáno"

                .Add(AGC("Vykázané hodiny", "Vykazano_Hodiny", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny", True, strFR, strHR))
                .Add(AGC("Vykázané hod.Fa", "Vykazano_Hodiny_Fa", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny_Fa", True, strFR, strHR))
                .Add(AGC("Vykázané hod.NeFa", "Vykazano_Hodiny_NeFa", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny_NeFa", True, strFR, strHR))
                .Add(AGC("Vykázané výdaje", "Vykazano_Vydaje", BO.cfENUM.Numeric2, , "alfa.Vykazano_Vydaje", True, strFR, strHR))
                .Add(AGC("Poslední úkon", "Vykazano_Posledni_Datum", BO.cfENUM.DateOnly, , "alfa.Vykazano_Posledni_Datum", False, strFR, strHR))

                strFR = "LEFT OUTER JOIN tview_p41_worksheet(@dp31f1,@dp31f2) alfa ON a.p41ID=alfa.p41ID" : strHR = "Vyfakturováno"
                .Add(AGC("Vyfakturované hodiny", "Vyfakturovano_Hodiny", BO.cfENUM.Numeric2, , "alfa.Vyfakturovano_Hodiny", True, strFR, strHR))
                .Add(AGC("Vyfakturovaná částka", "Vyfakturovano_Castka", BO.cfENUM.Numeric2, , "alfa.Vyfakturovano_Celkem_Domestic", True, strFR, strHR))
                .Add(AGC("Faktura naposledy", "Vyfakturovano_Naposledy_Kdy", BO.cfENUM.DateOnly, , "alfa.Vyfakturovano_Naposledy_Kdy", False, strFR, strHR))
                .Add(AGC("Faktura první", "Vyfakturovano_Poprve_Kdy", BO.cfENUM.DateOnly, , "alfa.Vyfakturovano_Poprve_Kdy", False, strFR, strHR))
                .Add(AGC("Počet faktur", "Vyfakturovano_PocetFaktur", BO.cfENUM.Numeric0, , "alfa.Vyfakturovano_PocetFaktur", False, strFR, strHR))

                strFR = "LEFT OUTER JOIN tview_p41_wip(@dp31f1,@dp31f2) beta ON a.p41ID=beta.p41ID" : strHR = "Rozpracováno"
                .Add(AGC("Rozpracované hodiny", "WIP_Hodiny", BO.cfENUM.Numeric2, , "beta.Hodiny", True, strFR, strHR))
                .Add(AGC("Rozpr.hod.Fa", "WIP_Hodiny_Fa", BO.cfENUM.Numeric2, , "beta.Hodiny_Fa", True, strFR, strHR))
                .Add(AGC("Rozpr.hod.NeFa", "WIP_Hodiny_NeFa", BO.cfENUM.Numeric2, , "beta.Hodiny_NeFa", True, strFR, strHR))
                .Add(AGC("Rozpracováno bez DPH", "WIP_Castka", BO.cfENUM.Numeric2, , "beta.Castka_Celkem", True, strFR, strHR))
                .Add(AGC("Rozpracovanoý honorář", "WIP_Honorar", BO.cfENUM.Numeric2, , "beta.Honorar", True, strFR, strHR))
                .Add(AGC("Rozpracovanoý honorář CZK", "WIP_Honorar_CZK", BO.cfENUM.Numeric2, , "beta.Honorar_CZK", True, strFR, strHR))
                .Add(AGC("Rozpracovaný honorář EUR", "WIP_Honorar_EUR", BO.cfENUM.Numeric2, , "beta.Honorar_EUR", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje", "WIP_Vydaje", BO.cfENUM.Numeric2, , "beta.Vydaje", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje CZK", "WIP_Vydaje_CZK", BO.cfENUM.Numeric2, , "beta.Vydaje_CZK", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje EUR", "WIP_Vydaje_EUR", BO.cfENUM.Numeric2, , "beta.Vydaje_EUR", True, strFR, strHR))
                .Add(AGC("Rozpracované paušály", "WIP_Odmeny", BO.cfENUM.Numeric2, , "beta.Odmeny", True, strFR, strHR))
                .Add(AGC("Rozpracované paušály CZK", "WIP_Odmeny_CZK", BO.cfENUM.Numeric2, , "beta.Odmeny_CZK", True, strFR, strHR))
                .Add(AGC("Rozpracované paušály EUR", "WIP_Odmeny_EUR", BO.cfENUM.Numeric2, , "beta.Odmeny_EUR", True, strFR, strHR))
                .Add(AGC("Poslední úkon", "WIP_Posledni_Datum", BO.cfENUM.DateOnly, , "beta.Posledni_Datum", False, strFR, strHR))
                .Add(AGC("První úkon", "WIP_Prvni_Datum", BO.cfENUM.DateOnly, , "beta.Prvni_Datum", False, strFR, strHR))
                .Add(AGC("Počet úkonů", "WIP_Pocet_Ukonu", BO.cfENUM.Numeric0, , "beta.Pocet", False, strFR, strHR))

                strFR = "LEFT OUTER JOIN tview_p41_notinvoiced(@dp31f1,@dp31f2) gama ON a.p41ID=gama.p41ID" : strHR = "Nevyfakturováno"
                .Add(AGC("Nevyfakturované hodiny", "NI_Hodiny", BO.cfENUM.Numeric2, , "gama.Hodiny", True, strFR, strHR))
                .Add(AGC("Hodiny Rozpracované", "NI_Hodiny_Rozpracovane", BO.cfENUM.Numeric2, , "gama.Hodiny_Rozpracovane", True, strFR, strHR))
                .Add(AGC("Hodiny Fakturovat", "NI_Hodiny_Fakturovat", BO.cfENUM.Numeric2, , "gama.Hodiny_Fakturovat", True, strFR, strHR))
                .Add(AGC("Hodiny Paušál", "NI_Hodiny_Pausal", BO.cfENUM.Numeric2, , "gama.Hodiny_Pausal", True, strFR, strHR))
                .Add(AGC("Hodiny Odpis", "NI_Hodiny_Odpis", BO.cfENUM.Numeric2, , "gama.Hodiny_Odpis", True, strFR, strHR))
                .Add(AGC("Hodiny Fakt.později", "NI_Hodiny_FakturovatPozdeji", BO.cfENUM.Numeric2, , "gama.Hodiny_FakturovatPozdeji", True, strFR, strHR))
                .Add(AGC("Nevyfakturováno bez DPH", "NI_Castka", BO.cfENUM.Numeric2, , "gama.Castka_Celkem", True, strFR, strHR))
                .Add(AGC("Nevyfakturovaný honorář", "NI_Honorar", BO.cfENUM.Numeric2, , "gama.Honorar", True, strFR, strHR))
                .Add(AGC("Nevyfakturovaný honorář CZK", "NI_Honorar_CZK", BO.cfENUM.Numeric2, , "gama.Honorar_CZK", True, strFR, strHR))
                .Add(AGC("Nevyfakturovaný honodář EUR", "NI_Honorar_EUR", BO.cfENUM.Numeric2, , "gama.Honorar_EUR", True, strFR, strHR))
                .Add(AGC("Nevyfakturované výdaje", "NI_Vydaje", BO.cfENUM.Numeric2, , "gama.Vydaje", True, strFR, strHR))
                .Add(AGC("Nevyfakturované paušály", "NI_Odmeny", BO.cfENUM.Numeric2, , "gama.Odmeny", True, strFR, strHR))
                .Add(AGC("Nevyfakturované paušály CZK", "NI_Odmeny_CZK", BO.cfENUM.Numeric2, , "gama.Odmeny_CZK", True, strFR, strHR))
                .Add(AGC("Nevyfakturované paušály EUR", "NI_Odmeny_EUR", BO.cfENUM.Numeric2, , "gama.Odmeny_EUR", True, strFR, strHR))
                .Add(AGC("Poslední úkon", "NI_Posledni_Datum", BO.cfENUM.DateOnly, , "gama.Posledni_Datum", False, strFR, strHR))
                .Add(AGC("První úkon", "NI_Prvni_Datum", BO.cfENUM.DateOnly, , "gama.Prvni_Datum", False, strFR, strHR))
                .Add(AGC("Počet úkonů", "NI_Pocet_Ukonu", BO.cfENUM.Numeric0, , "gama.Pocet", False, strFR, strHR))

                strFR = "LEFT OUTER JOIN tview_p41_approved(@dp31f1,@dp31f2) omega ON a.p41ID=omega.p41ID" : strHR = "Schváleno->Čeká na fakturaci"
                .Add(AGC("Schválené hodiny", "AP_Hodiny", BO.cfENUM.Numeric2, , "omega.Hodiny", True, strFR, strHR))
                .Add(AGC("Hodiny Fakturovat", "AP_Hodiny_Fakturovat", BO.cfENUM.Numeric2, , "omega.Hodiny_Fakturovat", True, strFR, strHR))
                .Add(AGC("Hodiny Paušál", "AP_Hodiny_Pausal", BO.cfENUM.Numeric2, , "omega.Hodiny_Pausal", True, strFR, strHR))
                .Add(AGC("Hodiny Odpis", "AP_Hodiny_Odpis", BO.cfENUM.Numeric2, , "omega.Hodiny_Odpis", True, strFR, strHR))
                .Add(AGC("Hodiny Fakt.později", "AP_Hodiny_FakturovatPozdeji", BO.cfENUM.Numeric2, , "omega.Hodiny_FakturovatPozdeji", True, strFR, strHR))
                .Add(AGC("Schváleno bez DPH", "AP_Castka", BO.cfENUM.Numeric2, , "omega.Castka_Celkem", True, strFR, strHR))
                .Add(AGC("Schválený honorář", "AP_Honorar", BO.cfENUM.Numeric2, , "omega.Honorar", True, strFR, strHR))
                .Add(AGC("Schválený honorář CZK", "AP_Honorar_CZK", BO.cfENUM.Numeric2, , "omega.Honorar_CZK", True, strFR, strHR))
                .Add(AGC("Schválený honorář EUR", "AP_Honorar_EUR", BO.cfENUM.Numeric2, , "omega.Honorar_EUR", True, strFR, strHR))
                .Add(AGC("Schválené výdaje", "AP_Vydaje", BO.cfENUM.Numeric2, , "omega.Vydaje", True, strFR, strHR))
                .Add(AGC("Schválené paušály", "AP_Odmeny", BO.cfENUM.Numeric2, , "omega.Odmeny", True, strFR, strHR))
                .Add(AGC("Schválené paušály CZK", "AP_Odmeny_CZK", BO.cfENUM.Numeric2, , "omega.Odmeny_CZK", True, strFR, strHR))
                .Add(AGC("Schválené paušály EUR", "AP_Odmeny_EUR", BO.cfENUM.Numeric2, , "omega.Odmeny_EUR", True, strFR, strHR))
                .Add(AGC("Poslední úkon", "AP_Posledni_Datum", BO.cfENUM.DateOnly, , "omega.Posledni_Datum", False, strFR, strHR))
                .Add(AGC("První úkon", "AP_Prvni_Datum", BO.cfENUM.DateOnly, , "omega.Prvni_Datum", False, strFR, strHR))
                .Add(AGC("Počet úkonů", "AP_Pocet_Ukonu", BO.cfENUM.Numeric0, , "omega.Pocet", False, strFR, strHR))
    ...
    Private Sub InhaleP28ColList(ByRef lis As List(Of BO.GridColumn))
        With lis
            ...
            If Factory.TestPermission(BO.x53PermValEnum.GR_P31_AllowRates) Then
                Dim strFR As String = "LEFT OUTER JOIN tview_p28_worksheet(@dp31f1,@dp31f2) alfa ON a.p28ID=alfa.p28ID", strHR As String = "Vykázáno"
                .Add(AGC("Vykázané hodiny", "Vykazano_Hodiny", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny", True, strFR, strHR))
                .Add(AGC("Vykázané hod.Fa", "Vykazano_Hodiny_Fa", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny_Fa", True, strFR, strHR))
                .Add(AGC("Vykázané hod.NeFa", "Vykazano_Hodiny_NeFa", BO.cfENUM.Numeric2, , "alfa.Vykazano_Hodiny_NeFa", True, strFR, strHR))
                .Add(AGC("Vykázané výdaje", "Vykazano_Vydaje", BO.cfENUM.Numeric2, , "alfa.Vykazano_Vydaje", True, strFR, strHR))
                ...
                strFR = "LEFT OUTER JOIN tview_p28_worksheet(@dp31f1,@dp31f2) alfa ON a.p28ID=alfa.p28ID" : strHR = "Vyfakturováno"
                .Add(AGC("Vyfakturované hodiny", "Vyfakturovano_Hodiny", BO.cfENUM.Numeric2, , "alfa.Vyfakturovano_Hodiny", True, strFR, strHR))
                .Add(AGC("Vyfakturovaná částka", "Vyfakturovano_Castka", BO.cfENUM.Numeric2, , "alfa.Vyfakturovano_Celkem_Domestic", True, strFR, strHR))
                .Add(AGC("Faktura naposledy", "Vyfakturovano_Naposledy_Kdy", BO.cfENUM.DateOnly, , "alfa.Vyfakturovano_Naposledy_Kdy", False, strFR, strHR))
                .Add(AGC("Faktura poprvé", "Vyfakturovano_Poprve_Kdy", BO.cfENUM.DateOnly, , "alfa.Vyfakturovano_Poprve_Kdy", False, strFR, strHR))
                .Add(AGC("Počet faktur", "Vyfakturovano_PocetFaktur", BO.cfENUM.Numeric0, , "alfa.Vyfakturovano_PocetFaktur", False, strFR, strHR))

                strFR = "LEFT OUTER JOIN tview_p28_wip(@dp31f1,@dp31f2) beta ON a.p28ID=beta.p28ID" : strHR = "Rozpracováno"
                .Add(AGC("Rozpracované hodiny", "WIP_Hodiny", BO.cfENUM.Numeric2, , "beta.Hodiny", True, strFR, strHR))
                .Add(AGC("Rozpr.hod.Fa", "WIP_Hodiny_Fa", BO.cfENUM.Numeric2, , "beta.Hodiny_Fa", True, strFR, strHR))
                .Add(AGC("Rozpr.hod.NeFa", "WIP_Hodiny_NeFa", BO.cfENUM.Numeric2, , "beta.Hodiny_NeFa", True, strFR, strHR))
                .Add(AGC("Rozpracováno bez DPH", "WIP_Castka", BO.cfENUM.Numeric2, , "beta.Castka_Celkem", True, strFR, strHR))
                .Add(AGC("Rozpraoovaný honorář", "WIP_Honorar", BO.cfENUM.Numeric2, , "beta.Honorar", True, strFR, strHR))
                .Add(AGC("Rozpracovaný honorář CZK", "WIP_Honorar_CZK", BO.cfENUM.Numeric2, , "beta.Honorar_CZK", True, strFR, strHR))
                .Add(AGC("Rozpracovaný honorář EUR", "WIP_Honorar_EUR", BO.cfENUM.Numeric2, , "beta.Honorar_EUR", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje", "WIP_Vydaje", BO.cfENUM.Numeric2, , "beta.Vydaje", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje CZK", "WIP_Vydaje_CZK", BO.cfENUM.Numeric2, , "beta.Vydaje_CZK", True, strFR, strHR))
                .Add(AGC("Rozpracované výdaje EUR", "WIP_Vydaje_EUR", BO.cfENUM.Numeric2, , "beta.Vydaje_EUR", True, strFR, strHR))
                ...
                strFR = "LEFT OUTER JOIN tview_p28_notinvoiced(@dp31f1,@dp31f2) gama ON a.p28ID=gama.p28ID" : strHR = "Nevyfakturováno"
                .Add(AGC("Nevyfakturované hodiny", "NI_Hodiny", BO.cfENUM.Numeric2, , "gama.Hodiny", True, strFR, strHR))
                .Add(AGC("Hodiny Rozpracované", "NI_Hodiny_Rozpracovane", BO.cfENUM.Numeric2, , "gama.Hodiny_Rozpracovane", True, strFR, strHR))
                .Add(AGC("Hodiny Fakturovat", "NI_Hodiny_Fakturovat", BO.cfENUM.Numeric2, , "gama.Hodiny_Fakturovat", True, strFR, strHR))
                .Add(AGC("Hodiny Paušál", "NI_Hodiny_Pausal", BO.cfENUM.Numeric2, , "gama.Hodiny_Pausal", True, strFR, strHR))
                ...
                strFR = "LEFT OUTER JOIN tview_p28_approved(@dp31f1,@dp31f2) omega ON a.p28ID=omega.p28ID" : strHR = "Schváleno->Čeká na fakturaci"
                .Add(AGC("Schválené hodiny", "AP_Hodiny", BO.cfENUM.Numeric2, , "omega.Hodiny", True, strFR, strHR))
                .Add(AGC("Hodiny Fakturovat", "AP_Hodiny_Fakturovat", BO.cfENUM.Numeric2, , "omega.Hodiny_Fakturovat", True, strFR, strHR))
                .Add(AGC("Hodiny Paušál", "AP_Hodiny_Pausal", BO.cfENUM.Numeric2, , "omega.Hodiny_Pausal", True, strFR, strHR))
                .Add(AGC("Hodiny Odpis", "AP_Hodiny_Odpis", BO.cfENUM.Numeric2, , "omega.Hodiny_Odpis", True, strFR, strHR))
    ...
    Private Sub InhaleJ02ColList(ByRef lis As List(Of BO.GridColumn))
        With lis
            ...
            Dim strFR As String = "LEFT OUTER JOIN tview_j02_wip(@dp31f1,@dp31f2) beta ON a.j02ID=beta.j02ID", strHR As String = "Rozpracováno"
            .Add(AGC("Rozpracované hodiny", "WIP_Hodiny", BO.cfENUM.Numeric2, , "beta.Hodiny", True, strFR, strHR))
            .Add(AGC("Rozpr.hod.Fa", "WIP_Hodiny_Fa", BO.cfENUM.Numeric2, , "beta.Hodiny_Fa", True, strFR, strHR))
            .Add(AGC("Rozpr.hod.NeFa", "WIP_Hodiny_NeFa", BO.cfENUM.Numeric2, , "beta.Hodiny_NeFa", True, strFR, strHR))
            .Add(AGC("Rozpraoovaný honorář", "WIP_Honorar", BO.cfENUM.Numeric2, , "beta.Honorar", True, strFR, strHR))
            .Add(AGC("Rozpracovaný honorář CZK", "WIP_Honorar_CZK", BO.cfENUM.Numeric2, , "beta.Honorar_CZK", True, strFR, strHR))
            .Add(AGC("Rozpracovaný honorář EUR", "WIP_Honorar_EUR", BO.cfENUM.Numeric2, , "beta.Honorar_EUR", True, strFR, strHR))
            .Add(AGC("Poslední Datum", "WIP_Posledni_Datum", BO.cfENUM.DateOnly, , "beta.Posledni_Datum", False, strFR, strHR))
            .Add(AGC("První Datum", "WIP_Prvni_Datum", BO.cfENUM.DateOnly, , "beta.Prvni_Datum", False, strFR, strHR))
            .Add(AGC("Počet úkonů", "WIP_Pocet_Ukonu", BO.cfENUM.Numeric0, , "beta.Pocet", False, strFR, strHR))

            strFR = "LEFT OUTER JOIN tview_j02_notinvoiced(@dp31f1,@dp31f2) gama ON a.j02ID=gama.j02ID" : strHR = "Nevyfakturováno"
            .Add(AGC("Nevyfakturované hodiny", "NI_Hodiny", BO.cfENUM.Numeric2, , "gama.Hodiny", True, strFR, strHR))
            .Add(AGC("Hodiny Rozpracované", "NI_Hodiny_Rozpracovane", BO.cfENUM.Numeric2, , "gama.Hodiny_Rozpracovane", True, strFR, strHR))
            .Add(AGC("Hodiny Fakturovat", "NI_Hodiny_Fakturovat", BO.cfENUM.Numeric2, , "gama.Hodiny_Fakturovat", True, strFR, strHR))
            .Add(AGC("Hodiny Paušál", "NI_Hodiny_Pausal", BO.cfENUM.Numeric2, , "gama.Hodiny_Pausal", True, strFR, strHR))
